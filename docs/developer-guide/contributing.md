...
and we appreciate it. We will do our best to work with you and get the PR looked at.

Working on your first Pull Request? You can learn how from this free video series:

[How to Contribute to an Open Source Project on GitHub](https://egghead.io/courses/how-to-contribute-to-an-open-source-project-on-github)

Unsure where to begin contributing to Resuminator? You can start by looking through these `Level 1`
and `good-first-issue` issues:
...
1. Follow all instructions in [the template](https://github.com/resuminator/resuminator/blob/main/.github/pull_request_template.md)
...
1. After you submit your pull request, verify that all
   ...
   :::note What if the status checks are failing?
   If a status check is failing, and you believe that the
   failure is unrelated to your change, please leave a comment on the pull request explaining why you believe
   the failure is unrelated. A maintainer will re-run the status check for you. If we conclude that the failure
   was a false positive, then we will open an issue to track that problem with our status check suite.
   :::
...
1. **Semantic commit messages**
   ...
   :::caution
   Non-sematic commit message in repository like **resuminator/server** will not be accepted. Multiple failure to comply
   will lead to ban from repository or invalid/spam contribution for any event.
   :::

1. **Lint**: All of our repositories uses linting. Please setup and use specified linting.
...
1. **Contributor License Agreement (CLA)**
   ...
   If you are submitting a pull request for the first time, the CLA Assistant will reply with a link to the CLA form.

### What happens next?

The core Resuminator team will be monitoring for pull requests. Do help us by keeping pull requests consistent by
